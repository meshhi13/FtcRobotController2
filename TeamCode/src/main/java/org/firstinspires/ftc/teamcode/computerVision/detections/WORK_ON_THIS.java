...
@Autonomous(name = "Red Cone Detection")
public class WORK_ON_THIS extends LinearOpMode {
    OpenCvCamera camera;
    ...
    public void runOpMode() {
        ...
        //place spike, move to backboard

        //make robot move towards the april tag position, then check april tags, then place pixel
