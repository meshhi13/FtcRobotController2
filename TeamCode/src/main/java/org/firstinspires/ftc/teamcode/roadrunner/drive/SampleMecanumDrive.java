...
public class SampleMecanumDrive extends MecanumDrive {
    /* TODO: Tune using BackAndForth and then FollowerPIDTuner */
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(8, 0, 0);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(8, 0, 0);

    /* TODO: Tune LATERAL_MULTIPLIER USING StrafeTest */
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        rightFront.setDirection(DcMotor.Direction.REVERSE);// F
        rightRear.setDirection(DcMotor.Direction.REVERSE); // F
        leftFront.setDirection(DcMotor.Direction.FORWARD); // R
        leftRear.setDirection(DcMotor.Direction.FORWARD);  // R
